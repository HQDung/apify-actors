# Vietnam Wedding Venue Lead Scraper with Emails

This Actor searches Google Maps for wedding venues and event venues in Vietnam, extracts business details, and attempts to find email addresses from available websites. It is useful for wedding service providers, event suppliers, B2B sales teams, and local marketing agencies.
...
| `keyword` | string | Search keyword for wedding venues and event venues |
