...
- **Target user:** Fitness equipment suppliers, wellness platforms, B2B sales teams, and local marketing agencies.
- **Buyer pain point:** Locating active gyms and decision-maker contact channels across a city is slow when done listing by listing.
- **Differentiation:** Fitness-niche Google Maps discovery with optional public website email extraction and lead-quality scoring.
...
| `keyword` | string | Search keyword for gyms and fitness centers |
