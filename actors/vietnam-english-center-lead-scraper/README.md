# Vietnam English Center Lead Scraper with Emails

This Actor searches Google Maps for English centers and language schools in Vietnam, extracts business details, and attempts to find email addresses from available websites. It is useful for education service providers, EdTech companies, B2B sales teams, and marketing agencies.
...
| `keyword` | string | Search keyword for English centers and language schools |
...
```json
{
  "keyword": "English center",
  "location": "Ho Chi Minh",
  "name": "Example English center",
  "rating": "4.5",
  "category": "English center",
