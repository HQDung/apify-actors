# Vietnam Restaurant Lead Scraper with Emails

This Actor searches Google Maps for restaurants, cafes, and food businesses in Vietnam, extracts business details, and attempts to find email addresses from available websites. It is useful for food suppliers, delivery platforms, POS vendors, B2B sales teams, and marketing agencies.
...
- **Target user:** Food suppliers, delivery platforms, POS vendors, B2B sales teams, and marketing agencies.
- **Buyer pain point:** Reaching a broad set of local food businesses is difficult when contact research depends on manual map and website visits.
- **Differentiation:** Restaurant and cafe-focused Google Maps discovery with optional public website email extraction and lead-quality scoring.
...
| `keyword` | string | Search keyword for restaurants, cafes, and food businesses |
